...
<head>
    ...
    <!-- Site favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="http://administrator.test/vendors/images/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="http://administrator.test/vendors/images/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="http://administrator.test/vendors/images/favicon-16x16.png">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap"
        rel="stylesheet">
    <!-- CSS -->
    <link rel="stylesheet" type="text/css" href="   http://administrator.test/vendors/styles/core.css">
    <link rel="stylesheet" type="text/css" href="   http://administrator.test/vendors/styles/icon-font.min.css">
    <link rel="stylesheet" type="text/css"
        href="   http://administrator.test/src/plugins/datatables/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" type="text/css"
        href="   http://administrator.test/src/plugins/datatables/css/responsive.bootstrap4.min.css">
    <link rel="stylesheet" type="text/css" href="   http://administrator.test/vendors/styles/style.css">
...
<body>
    ...
    <div class="left-side-bar">
        <div class="brand-logo">
            <a href="/">
                <img src="http://administrator.test/vendors/images/deskapp-logo.svg" alt="" class="dark-logo">
                <img src="http://administrator.test/vendors/images/deskapp-logo-white.svg" alt="" class="light-logo">
            </a>
                                ...
                                <div class="dropdown">
                                    <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                                        <span class="user-icon">
                                            <img src="http://administrator.test/vendors/images/photo1.jpg" alt="">
                                        </span>
    ...
    <script src="http://administrator.test/src/plugins/datatables/js/jquery.dataTables.min.js"></script>
    <script src="http://administrator.test/src/plugins/datatables/js/dataTables.bootstrap4.min.js"></script>
    <script src="http://administrator.test/src/plugins/datatables/js/dataTables.responsive.min.js"></script>
    <script src="http://administrator.test/src/plugins/datatables/js/responsive.bootstrap4.min.js"></script>
